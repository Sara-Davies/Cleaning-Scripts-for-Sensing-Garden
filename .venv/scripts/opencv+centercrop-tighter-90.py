...
class InsectDatasetCleaner:
    ...
    def compute_center_rgb(self, img_path):
        ...
        try:
            ...
            w, h = img.size
            crop_box = (w * 0.4, h * 0.4, w * 0.6, h * 0.6)
    ...
    def apply_all_filters(self, img_path):
        ...
        # Edge density check
        # pass_edges, edges_reason = self.check_edge_density(img_path)
        # filters_results['edges'] = (pass_edges, edges_reason)
    ...
    def filter_dataset_comprehensive(self, train_dir, output_dir, keep_percent):
...
cleaner.filter_dataset_comprehensive(
    ...
    output_dir="/Users/scl/PycharmProjects/Filter-Metrics/.venv/data/cleaned-large-crop-90",
    keep_percent=90
)